...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Banned Emails', 'js-support-ticket') ?></span>
        <a class="js-add-link button" href="?page=banemail&jstlay=addbanemail"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Email', 'js-support-ticket') ?></a>
        </span>
        ...
        <?php if (!empty(jssupportticket::$_data[0])) { ?>
            <div class="js-filter-form-list">
                ...
                echo " : "; ?></span><?php if(isset($email->staffname) && $email->staffname != '') echo $email->staffname; else echo $email->user_nicename; ?></div>
                ...
                echo " : "; ?></span><?php echo date_i18n(jssupportticket::$_config['date_format'], strtotime($email->created)); ?></div>
                        <div class="js-col-md-3 js-col-xs-12 seventh js-filter-form-action-hl-xs">
                            <a href="?page=banemail&jstlay=addbanemail&jssupportticketid=<?php echo $email->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/edit.png" /></a>&nbsp;&nbsp;
                            <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=banemail&task=deletebanemail&action=jstask&banemailid='. $email->id, 'delete-banemail'); ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /></a>
                        </div>
                    </div>
