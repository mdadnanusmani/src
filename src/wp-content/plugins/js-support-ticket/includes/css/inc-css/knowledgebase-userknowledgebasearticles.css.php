...
$jssupportticket_css .= '
	...
	div.js-ticket-head-category-image{position: absolute;left: 15px;top: -8px;padding: 5px;width: 70px;height: 70px;text-align: center;}
	img.js-ticket-kb-dtl-img{max-width: 85%;margin: auto;position: absolute;right: 0;left: 0;top: 0;bottom: 0;}
	span.js-ticket-head-text{display: inline-block;margin-left: 80px;}
