...
class JSSTcustomfields {
    function formCustomFields($field) {
        ...
        $html = '<div class="' . $div1 . '">
               <div class="' . $div2 . '">';
        if ($required == 1) {
            $html .= __($field->fieldtitle,'js-support-ticket') . '<span style="color: red;" >*</span>';
            ...
            case 'file':
                ...
                case 'termsandconditions':
                    ...
                    if (!empty($field->userfieldparams)) {
                        ...
                        $html .= '<div class="js-ticket-custom-terms-and-condition-box">';
                        $html .= '<input type="checkbox" class="radiobutton js-ticket-append-radio-btn" value="1" id="' . $field->field . '" name="' . $field->field . '" required="required" data-validation="required">';
