...
if(isset($_SESSION['jsst-addon-key-error-message']) && $_SESSION['jsst-addon-key-error-message'] != ''){
	echo '<div class="notice notice-error is-dismissible"><p>'. $_SESSION['jsst-addon-key-error-message'] .'</p></div>';
	unset($_SESSION['jsst-addon-key-error-message']);
}
?>
