...
Professional, beautiful and more powerful help desk system for tracking, prioritizing and providing assistance to customers.

== Description ==
JS Help Desk is a trusted open source ticket system. JS Help Desk is a simple, easy to use, web-based customer support system. User/Guest can create ticket from front-end. JS Help Desk comes packed with lot features than most of the expensive(and complex) support ticket system on market. The best part is, It completely free.

= JS Help Desk Demo =
* [Free Version Demo](https://demo.joomsky.com/tickets/free)  
* [Pro Version Demo](https://demo.joomsky.com/tickets/pro)  
* [Plugin Homepage](https://jshelpdesk.com/)  

http://www.youtube.com/watch?v=x_cybXTQq8E
...
* Admin can esily publish unpublished ticket fields
...
* Easy to Use
* Unlimited Departments
* Fields Ordering, admin can change ticket fields ordering also unpublished unwanted fields.
* Shortcodes for the My Tickets and New Ticket Form
* Fully Customizable & Configurable
* Easy To Translate
* Bootstrap base design
* JS Help Desk Captcha and Google ReCaptcha are include
...
* Announcements -Disply your announcement to your users is not a problem in JS Help Desk, admin/staff member easily manage it.
...
No limit on tickets at both side front-end and admin. They can create unlimited tickets. Admin can limit user ticket on email base.

= Strength & Flexibility =

JS Help Desk is built using WordPress best practises both on the front and the back end. This results in an efficient, robust and intuitive plugin.

= Easy to Use = 

Ticket system build on the basis on latest style. You will find it very easy to use. 
...
JS Help Desk using these shortcodes.
- [jssupportticket] for JS Help Desk control panel
...
Custom fields are required in scenarios, wherein additional information from clients is required. For example, if a client registers his account, additional information like company name, company profile etc. would be required, OR while submitting tickets related to technical issues, server access is required in tracing technical issues. This can be gathered by using Custom Fields.
You can create different types of custom fields i.e text field, drop down, check box, date, text area.

= Unlimited Departments =

Create departments that relates to the various business units in your organization. It will be sale, support, billing, you can create any department in admin panel. User will select department when he create the ticket.
...
= Priority =
Priority associated to the ticket defines the importance that is to be given to the ticket. Change the priority of the Ticket from High or Medium or low from the Priority field. Admin also define prority color admin panel.

= Field Ordering =
Admin can esily change ticket form field ordering. Admin can also unpublished unwanted fields. 

= Attachments =

JS Help Desk allows your customers to attach files with their messages. 

= Multi-Language =

JS Help Desk is multi-language. You can download latest translations.
[JS Help Desk translations](https://www.transifex.com/projects/p/js-support-ticket/)   

== Installation ==

= Automatic installation =

Automatic installation is the easiest option as WordPress handles the file transfers itself and you don not need to leave your web browser. To do an automatic install of JS Help Desk, log in to your WordPress dashboard, navigate to the Plugins menu and click Add New.
In the search field type  JS Help Desk  and click Search Plugins. Once you have found our help desk plugin you can view details about it such as the the point release, rating and description. Most importantly of course, you can install it by simply clicking  Install Now.

= Manual installation =

The manual installation method involves downloading our help desk plugin and uploading it to your webserver via your favourite FTP application. The WordPress codex contains [instructions on how to do this here](http://codex.wordpress.org/Managing_Plugins#Manual_Plugin_Installation).
...
9. My Tickets - front-end

10. Create new ticket - front-end

11. Ticket Details - front-end

12. Overall Reports

13. Customer Feedbacks

14. Report by Staff Members

15. Report by Departments

16. Timer

17. Feedback

18. Staff Member Control Panel

19. Staff Member Tickets

20. Staff Members List
...
= 2.1.6 =
* Create ticket bug fix

= 2.1.5 =
* New custom field type for terms and conditions
* New addon for woocommerce support
* New addon for private credentials
* Configuration page typography issue fix
* Minor bugs fixed

= 2.1.4 =
* Configurations bug fix

= 2.1.3 =
* Add admin capability for ticket management

= 2.1.2 =
* Integrate JS Desktop Notification plugin
* Security check for ajax calls
* Support icon size change
...
* Security improved, curl remove with WP library
...
= 2.0.5 =
* Admin controlable login button link
* MariaDB bug fix
...
= 2.0.3 =
* PHP 7.0.1 support
* Admin reply css bug fix
* Add left menu for admin

= 2.0.2 =
* Add department and priority fields in email templates
...
* Add support icon with various position option

= 1.0.9 =
* Improve user search

= 1.0.8 =
* Add slug for JS Help Desk to avoid conflict with other pages and posts
...
* User redirect to JS Help Desk control panel after login [configurable]
...
* Admin responsive layout, now JS Help Desk fully responsive.
* SEF improve
