...
<script type="text/javascript">
    ...
    jQuery(document).ready(function(){
        ...
        if(jQuery("#wcorderid").val()){
            var productid = '<?php echo isset(jssupportticket::$_data[0]) ? jssupportticket::$_data[0]->wcproductid : ''; ?>';
            jsst_wc_order_products(productid);
        }
    });
</script>
...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=ticket&jstlay=tickets');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Add Ticket', 'js-support-ticket'); ?></span></span>
                        ...
                        switch ($field->field) {
                                ...
                                <div class="js-form-wrapper">
                                    ...
                                    <div class="js-form-field" id="helptopic">
                                        <?php
                                            ...
                                            echo JSSTformfield::select('helptopicid', JSSTincluder::getJSModel('helptopic')->getHelpTopicsForCombobox($departmentid), $helptopicid, __('Select Help Topic', 'js-support-ticket'), array('class' => 'inputbox','data-validation'=>($field->required) ? 'required': ''));
                                        ?>
                                    </div>
                                </div>
                                <?php
                                ...
                                <div class="js-form-wrapper">
                                    ...
                                    <div class="js-form-field">
                                        <?php
                                            ...
                                            echo JSSTformfield::select('staffid', JSSTincluder::getJSModel('agent')->getStaffForCombobox(), $staffid, __('Select Staff', 'js-support-ticket'), array('class' => 'inputbox','data-validation'=>($field->required) ? 'required': ''));
                                        ?>
                                    </div>
                                </div>
                                <?php
                            ...
                            case 'premade':
                                ...
                                <div class="js-form-wrapper">
                                    <div class="js-form-title"><?php echo __($field->fieldtitle, 'js-support-ticket'); ?></div>
                                    <div class="js-form-field">
                                        <span id="premade"><?php echo JSSTformfield::select('premadeid', JSSTincluder::getJSModel('cannedresponses')->getPreMadeMessageForCombobox(), isset(jssupportticket::$_data[0]->premadeid) ? jssupportticket::$_data[0]->premadeid : '', __('Select Premade', 'js-support-ticket'), array('class' => 'inputbox', 'onchange' => 'getpremade(this.value)')); ?></span>
                            ...
                            case 'wcorderid':
                                ...
                                <div class="js-form-wrapper">
                                    ...
                                    <div class="js-form-field">
                                        <?php
                                            $orderlist = array();
											foreach(wc_get_orders(array('post_status' => 'wc-completed')) as $order){
                                            ...
                                            echo JSSTformfield::select('wcorderid', $orderlist, $wcorderid, __('Select Order', 'js-support-ticket'), array('class' => 'inputbox js-ticket-select-field')); ?>
                                    </div>
                                </div>
                                <?php
                                break;
                            case 'wcproductid':
                                ...
                                <div class="js-form-wrapper">
                                    <div class="js-form-title"><?php echo __($field->fieldtitle, 'js-support-ticket'); ?><?php if($field->required == 1) echo '&nbsp;<span style="color: red;" >*</span>'; ?></div>
                                    <div class="js-form-field" id="wcproductid-wrap">
                                        <?php
                                            $itemlist = array();
                                            ...
                                            echo JSSTformfield::select('wcproductid', $itemlist, $wcproductid, __('Select Product', 'js-support-ticket'), array('class' => 'inputbox js-ticket-select-field')); ?>
                                    </div>
                                </div>
                                <?php
                                break;
