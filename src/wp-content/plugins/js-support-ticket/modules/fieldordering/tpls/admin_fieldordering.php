...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Field Ordering', 'js-support-ticket') ?></span>
        <a class="js-add-link button" href="?page=fieldordering&jstlay=adduserfeild&&fieldfor=<?php echo jssupportticket::$_data['fieldfor']; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add User field', 'js-support-ticket'); ?></a>
        </span>
                        ...
                        <span class="js-support-ticket-table-responsive-heading"><?php echo __('Action','js-support-ticket'); ?>:</span>
                            <?php
                                if($field->isuserfield==1){
                                    echo '<a href="?page=fieldordering&jstlay=adduserfeild&jssupportticketid='.$field->id.'&fieldfor='.jssupportticket::$_data['fieldfor'].'"><img alt="image" src="'.jssupportticket::$_pluginpath.'includes/images/edit.png" /></a>&nbsp;';
                                    echo '<a onclick="return confirm(\''.__('Are you sure to delete','js-support-ticket').'\');" href="'.wp_nonce_url('?page=fieldordering&task=removeuserfeild&action=jstask&jssupportticketid='.$field->id.'&fieldfor='.jssupportticket::$_data['fieldfor'],'remove-userfeild').'"><img alt="image" src="'.jssupportticket::$_pluginpath.'includes/images/remove.png" /></a>';
                                }else{
                                    echo '---';
                                }
                            ?>
