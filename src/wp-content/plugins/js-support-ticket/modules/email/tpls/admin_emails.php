...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('System Emails', 'js-support-ticket'); ?></span>
        <a class="js-add-link button" href="?page=email&jstlay=addemail"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Email', 'js-support-ticket'); ?></a>
        </span>
        <span id="js-systemail" class="js-admin-infotitle"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/infoicon.png" /><?php echo __('System email used for sending email', 'js-support-ticket'); ?></span>
        ...
        <?php if (!empty(jssupportticket::$_data[0])) { ?>
            <div class="js-filter-form-list">
                <div class="js-filter-form-head js-filter-form-head-xs">
                    ...
                    <div class="js-col-xs-12 js-col-md-2 js-textaligncenter fourth"><?php echo __('Created', 'js-support-ticket'); ?></div>
                ...
                echo " : "; ?></span><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/<?php echo $autoresponse; ?>" /></div>
                        ...
                        <div class="js-col-xs-12 js-col-md-2 js-textaligncenter fourth"><span class="js-filter-form-data-xs"><?php echo __('Created', 'js-support-ticket');
                echo " : "; ?></span><?php echo date_i18n(jssupportticket::$_config['date_format'], strtotime($email->created)); ?></div>
                        <div class="js-col-xs-12 js-col-md-2 fifth js-filter-form-action-hl-xs">
                            <a href="?page=email&jstlay=addemail&jssupportticketid=<?php echo $email->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/edit.png" /></a>
                            <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=email&task=deleteemail&action=jstask&emailid=' .$email->id,'delete-email'); ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /></a>
                        </div>
                    </div>
                <?php }
            ?>
