...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('System Errors', 'js-support-ticket'); ?></span></span>
                ...
                foreach (jssupportticket::$_data[0] AS $systemerror) {
                    ...
                    <div class="js-filter-form-data">
                        ...
                        <div class="js-col-xs-12 js-col-md-1 js-textaligncenter second"><span class="js-filter-form-data-xs"><?php
                                ...
                                echo " : ";
                                ?></span><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/<?php echo $isview; ?>" /></div>
