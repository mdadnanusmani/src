...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=priority&jstlay=priorities');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Add Priority', 'js-support-ticket'); ?></span></span>
        <form method="post" action="<?php echo admin_url("?page=priority&task=savepriority"); ?>">
            ...
            <div class="js-form-wrapper">
                ...
                <div class="js-form-field"><?php echo JSSTformfield::select('overduetypeid', $dayshours , (isset(jssupportticket::$_data[0]->overduetypeid) ? jssupportticket::$_data[0]->overduetypeid : '' ))?></div>
            </div>
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Ticket Overdue', 'js-support-ticket') ?></div>
                <div class="js-form-field"><?php echo JSSTformfield::text('overdueinterval', isset(jssupportticket::$_data[0]->overdueinterval) ? jssupportticket::$_data[0]->overdueinterval : '', array('class' => 'inputbox')) ?><span class="ticket_overdue_type_text" ><?php echo isset(jssupportticket::$_data[0]->overduetypeid) ? jssupportticket::$_data[0]->overduetypeid : '' ?></span></div>
            </div>
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Public', 'js-support-ticket'); ?></div>
                <div class="js-form-field"><?php echo JSSTformfield::radiobutton('ispublic', array('1' => __('Yes', 'js-support-ticket'), '0' => __('No', 'js-support-ticket')), isset(jssupportticket::$_data[0]->ispublic) ? jssupportticket::$_data[0]->ispublic : '1', array('class' => 'radiobutton')); ?></div>
            </div>
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Default', 'js-support-ticket'); ?></div>
                <div class="js-form-field"><?php echo JSSTformfield::radiobutton('isdefault', array('1' => __('Yes', 'js-support-ticket'), '0' => __('No', 'js-support-ticket')), isset(jssupportticket::$_data[0]->isdefault) &&  jssupportticket::$_data[0]->isdefault == 1 ? 1 : 0, array('class' => 'radiobutton')); ?></div>
            </div>
            <div class="js-form-wrapper">
