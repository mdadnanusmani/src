...
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
        <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=department&jstlay=departments');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Add Department', 'js-support-ticket'); ?></span></span>
        <form method="post" action="<?php echo admin_url("admin.php?page=department&task=savedepartment"); ?>">
            ...
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Outgoing Email', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span> </div>
            ...
            <div class="js-form-wrapper" >
                ...
                <div class="js-form-field"><?php echo JSSTformfield::radiobutton('sendmail', array('1' => __('Yes', 'js-support-ticket'), '0' => __('No', 'js-support-ticket')), isset(jssupportticket::$_data[0]->sendmail) ? jssupportticket::$_data[0]->sendmail : '0', array('class' => 'radiobutton')); ?></div>
            </div>
            <div class="js-form-wrapper">
            ...
            <div class="js-form-wrapper" >
                ...
                <div class="js-form-field"><?php echo JSSTformfield::radiobutton('isdefault', array('1' => __('Yes', 'js-support-ticket'), '0' => __('No', 'js-support-ticket')), isset(jssupportticket::$_data[0]->isdefault) ? jssupportticket::$_data[0]->isdefault : '0', array('class' => 'radiobutton')); ?></div>
            </div>
