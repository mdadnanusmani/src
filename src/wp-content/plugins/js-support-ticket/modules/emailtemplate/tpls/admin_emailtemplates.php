...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Email Templates', 'js-support-ticket') ?></span></span>
        <form method="post" action="<?php echo admin_url("?page=emailtemplate&task=saveemailtemplate"); ?>">
            <div class="js-email-menu">
                ...
                <span class="js-email-menu-link <?php if (jssupportticket::$_data[1] == 'fd-bk') echo 'selected'; ?>"><a class="js-email-link" href="?page=emailtemplate&for=fd-bk"><?php echo __('Feedback Email To User', 'js-support-ticket'); ?></a></span>
                <span class="js-email-menu-link <?php if (jssupportticket::$_data[1] == 'no-rp') echo 'selected'; ?>"><a class="js-email-link" href="?page=emailtemplate&for=no-rp"><?php echo __('User Reply On Closed Ticket', 'js-support-ticket'); ?></a></span>
            </div>
