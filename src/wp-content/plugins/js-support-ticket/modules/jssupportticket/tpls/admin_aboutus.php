<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('About Us','js-support-ticket'); ?></span>
		</span>
		...
		<div class="js-admin-joomsky-wrapper">
			<span class="js-admin-title">
				<img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/aboutus_page/logo.png" />
				Joom Sky
			</span>
			...
			<div class="js-col-md-4">
					...
					<img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/aboutus_page/product-images.png" />
				</a>
			</div>
		</div>
		...
		<div class="js-col-md-4">
			<a href="http://www.joomsky.com/index.php/products/js-jobs-1/js-jobs-pro" target="_blank">
				<img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/aboutus_page/jobs.jpg" />
			</a>
		</div>
		<div class="js-col-md-4">
			<a href="http://www.joomsky.com/index.php/products/js-autoz-1/js-autoz-pro" target="_blank">
				<img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/aboutus_page/autoz.jpg" />
			</a>
		</div>
		<div class="js-col-md-4">
			<a href="http://www.joomsky.com/index.php/products/js-support-ticket-1/js-supprot-ticket-pro-wp" target="_blank">
				<img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/aboutus_page/tickets.jpg" />
			</a>
		</div>
	</div>
</div>
