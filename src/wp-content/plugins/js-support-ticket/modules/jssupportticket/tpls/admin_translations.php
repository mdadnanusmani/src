...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Translations','js-support-ticket'); ?></span></span>
    ...
    <div id="jssupportticket-content">
        ...
        <div id="js-language-wrapper">
            ...
            <div id="js-emessage-wrapper">
                <img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/c_error.png" />
                <div id="jslang_em_text"></div>
            </div>
            <div id="js-emessage-wrapper_ok">
                <img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/saved.png" />
                <div id="jslang_em_text_ok"></div>
            </div>
        </div>
        <div id="js-lang-toserver">
            <div class="js-col-xs-12 js-col-md-8 col"><a class="anc one" href="https://www.transifex.com/joom-sky/js-support-ticket" target="_blank"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/translation-icon.png" /><?php echo __('Contribute In Translation','js-support-ticket'); ?></a></div>
            <div class="js-col-xs-12 js-col-md-4 col"><a class="anc two" href="http://www.joomsky.com/translations.html" target="_blank"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/manual-download.png" /><?php echo __('Manual Download','js-support-ticket'); ?></a></div>
        </div>
    </div>
</div>
