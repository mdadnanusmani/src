...
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
    	<span class="js-adminhead-title"> <a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=reports&jstlay=userreport');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a> <span class="jsheadtext"><?php echo __("Report By User", 'js-support-ticket') ?></span>
		...
		<form class="js-filter-form js-report-form" name="jssupportticketform" id="jssupportticketform" method="post" action="<?php echo admin_url("admin.php?page=reports&jstlay=userdetailreport&id=".jssupportticket::$_data['user_report']->id); ?>">
		    <?php
		...
		<span class="js-admin-subtitle"><?php echo __('User','js-support-ticket'); ?></span>
