...
<div id="jsstadmin-wrapper">
    ...
    <div id="jsstadmin-data">
        <span class="js-adminhead-title"> <a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a> <span class="jsheadtext"><?php echo __("Overall Report", 'js-support-ticket') ?></span>
            <?php if(in_array('export', jssupportticket::$_active_addons)){ ?>
                <a id="jsexport-link" class="js-add-link button" href="?page=export&task=getoverallexport&action=jstask"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/export-icon.png" /><?php echo __('Export Data', 'js-support-ticket'); ?></a>
            <?php } ?>
        </span>
