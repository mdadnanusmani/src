...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=helptopic&jstlay=helptopics');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Add Help Topic', 'js-support-ticket'); ?></span>
        </span>
        <form method="post" action="<?php echo admin_url("admin.php?page=helptopic&task=savehelptopic"); ?>">
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Help Topic', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
            ...
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Department', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
            ...
            <div class="js-form-wrapper">
                ...
                if(isset(jssupportticket::$_data[0])){
                    $checked = jssupportticket::$_data[0]->autoresponce==1 ? 1 : 0;
                }else{
                    $checked = 1;
                }
                echo JSSTformfield::checkbox('autoresponce', array('1' => __('Auto response for this topic','js-support-ticket').' ( '.__('override department setting', 'js-support-ticket').' )'),$checked , array('class' => 'radiobutton')); ?></div>
            </div>
