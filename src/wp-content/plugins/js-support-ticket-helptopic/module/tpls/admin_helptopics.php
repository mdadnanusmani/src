...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Help Topics', 'js-support-ticket') ?></span>
        <a class="js-add-link button" href="?page=helptopic&jstlay=addhelptopic"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Help Topic', 'js-support-ticket') ?></a>
        </span>
        ...
        if (!empty(jssupportticket::$_data[0])) {
            ...
            <div class="js-filter-form-list">
                ...
                foreach (jssupportticket::$_data[0] AS $helptopic) {
                    ...
                    echo " : "; ?></span> <img alt="image" src="<?php echo jssupportticket::$_pluginpath . 'includes/images/' . $autoreponce; ?>" /></div>
                    ...
                    echo " : "; ?></span><a href="<?php echo wp_nonce_url('?page=helptopic&task=changestatus&action=jstask&helptopicid='.$helptopic->id,'change-status');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath . 'includes/images/' . $status; ?>"/> </a></div>
                    ...
                    echo " : "; ?></span>
                            <?php if ($number != 0 || $pagenum > 1) {
                                $url  = "?page=helptopic&task=ordering&action=jstask&order=up&helptopicid=".$helptopic->id;
                                if($pagenum > 1){
                                    $url .= '&pagenum=' . $pagenum;
                                } ?>
                            ...
                            if ($number < $count) {
                                $url  = "?page=helptopic&task=ordering&action=jstask&order=down&helptopicid=".$helptopic->id;
                                if($pagenum > 1){
                                    $url .= '&pagenum=' . $pagenum;
                                } ?>
                    ...
                    echo " : "; ?></span><?php echo $updated; ?></div>
                        <div class="js-col-md-2 js-col-xs-12 seventh js-filter-form-action-hl-xs">
                            <a href="?page=helptopic&jstlay=addhelptopic&jssupportticketid=<?php echo $helptopic->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/edit.png" /></a>&nbsp;&nbsp;
                            <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=helptopic&task=deletehelptopic&action=jstask&helptopicid='.$helptopic->id,'delete-help-topic');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /></a>
                        </div>
                    </div>
