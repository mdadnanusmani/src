...
// Creating the widget
class JSSTmailnotification_addon_widget extends WP_Widget {

    function __construct() {
        parent::__construct(
// Base ID of your widget
                'JSSTmailnotification_addon_widget',
        ...
        if(jssupportticket::$_data['widget_mailnotification'] != false){
            ...
            ?>
                <div id="jsst-widget-mailnotification-wrapper" class="<?php echo $layoutcss; ?>">
                    <?php if ($staff->photo) { ?>
                        <img  src="<?php echo $path.'/'. jssupportticket::$_config['data_directory'] . "/staffdata/staff_" . $staff->staffid . "/" . $staff->photo; ?>">
                    <?php } else { ?>
...
function JSSTmailnotification_addon_load_widget() {
    register_widget('JSSTmailnotification_addon_widget');
}

add_action('widgets_init', 'JSSTmailnotification_addon_load_widget');
?>
