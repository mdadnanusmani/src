...
// Creating the widget
class JSSTmyticket_addon_widget extends WP_Widget {

    function __construct() {
        parent::__construct(
// Base ID of your widget
                'JSSTmyticket_addon_widget',
            ...
            ?>
                <div id="jsst-widget-myticket-wrapper" class="<?php echo $layoutcss; ?>">
                    <div class="jsst-widget-myticket-topbar">
                        <span class="jsst-widget-myticket-subject"><a href="<?php echo esc_url(jssupportticket::makeUrl(array('jstmod'=>'ticket', 'jstlay'=>'ticketdetail', 'jssupportticketid'=>$ticket->id,'jsstpageid'=>jssupportticket::getPageid()))); ?>"><?php echo $ticket->subject; ?></a></span>
                        <span class="jsst-widget-myticket-status" style="background:<?php echo ($ticket->status == 0) ? '#9ACC00' : '#217ac3'; ?>"><?php echo ($ticket->status == 0) ? __('New','js-support-ticket'): __('Waiting Reply','js-support-ticket'); ?></span>
                    </div>
...
function JSSTmyticket_addon_load_widget() {
    register_widget('JSSTmyticket_addon_widget');
}

add_action('widgets_init', 'JSSTmyticket_addon_load_widget');
?>
