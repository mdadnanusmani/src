...
class JSTActionsactivation {

    static function jssupportticketaddon_activate() {
        // Install Database
        JSTActionsactivation::runSQL();
    }

    static function jssupportticketaddon_deactivate() {
        // string config for reactivation
        $query = "SELECT configvalue,configname  FROM `" . jssupportticket::$_db->prefix . "js_ticket_config` WHERE addon = 'actions';";
