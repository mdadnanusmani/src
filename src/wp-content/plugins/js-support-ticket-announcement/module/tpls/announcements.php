        ...
        <div class="js-ticket-download-wrapper">
            <div class="js-ticket-top-search-wrp">
                ...
                <div class="js-ticket-search-fields-wrp">
                   <form class="js-filter-form" name="jssupportticketform" id="jssupportticketform" method="POST" action="<?php echo jssupportticket::makeUrl(array('jstmod'=>'announcement', 'jstlay'=>'announcements')); ?>">
                        <div class="js-ticket-fields-wrp">
                            <div class="js-ticket-form-field js-ticket-form-field-download-search">
                                <?php echo JSSTformfield::text('jsst-search', jssupportticket::parseSpaces(jssupportticket::$_data['filter']['jsst-search']), array('placeholder' => __('Search', 'js-support-ticket'), 'class' => 'js-ticket-field-input')); ?>
                            </div>
                        ...
                        <div class="js-ticket-categories-content">
                            <?php foreach (jssupportticket::$_data[0]['categories'] as $category) { ?>
                                <div class="js-ticket-category-box">
                                    <a class="js-ticket-category-title" href="<?php echo esc_url(jssupportticket::makeUrl(array('jstmod'=>'announcement', 'jstlay'=>'announcements', 'jssupportticketid'=>$category->id))); ?>">
                                        <span class="js-ticket-category-name">
                                            <?php echo $counter . ".  " . $category->name; ?>
                                        </span>
                                        <span class="js-ticket-category-download-logo">
                                            <img alt="img" class="js-ticket-download-img" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/arrowicon.png" />
                                        </span>
                                    </a>
                                </div>
                            <?php $counter ++;
        ...
        ?>
            <div class="js-ticket-downloads-wrp">
                <div class="js-ticket-downloads-heading-wrp">
                    ...
                    if (isset(jssupportticket::$_data[0]['categoryname'])) echo ' > ' . jssupportticket::$_data[0]['categoryname']->name; ?>
                </div>
                <?php
                if (jssupportticket::$_data[0]['announcements']) { ?>
                    <div class="js-ticket-downloads-content">
                        <?php foreach (jssupportticket::$_data[0]['announcements'] as $announcement) { ?>
                            <div class="js-ticket-download-box">
                                <div class="js-ticket-download-left">
                                    <a class="js-ticket-download-title js-ticket-kb-title " href="<?php echo esc_url(jssupportticket::makeUrl(array('jstmod'=>'announcement', 'jstlay'=>'announcementdetails', 'jssupportticketid'=>$announcement->id))); ?>">
                                        <img alt="img" class="js-ticket-download-icon" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/kb/file.png" />
