...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=announcement&jstlay=announcements');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Add Announcement', 'js-support-ticket'); ?></span></span>
        <form method="post" action="<?php echo admin_url("admin.php?page=announcement&task=saveannouncement"); ?>">
            ...
            <?php
                ...
                <div class="js-form-title"><?php echo __('Type', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
