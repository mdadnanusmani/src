<?php
/**
* @package JS Support Ticket Export
* @version 1.0.0
*/
/*
Plugin Name: JS Support Ticket Export
Plugin URI: https://www.joomsky.com
Description:  Export Addon for JS Support Ticket.
Author: Joom Sky
Version: 1.0.0
...
class JSSTExport{
    ...
    //         update_option('jsst-addon-export-version',JSSTExport::$_addon_version);
    //     }
    // }
    ...
    function jstsupportitkcetaddon_activate_hook(){
        ...
        if(!JSSTincluder::getJSModel('jssupportticket')->updateDate('export',$plugin_version)){
            do_action('jsst_addon_update_date_failed');
        }
        update_option('jsst-addon-export-version',JSSTExport::$_addon_version);
        // include_once 'includes/activation.php';
        // JSTExporteactivation::jssupportticketaddon_activate();
    ...
    function jssupportticketaddon_deactivate_hook(){
        if (class_exists('jssupportticket') ) {
            JSSTincluder::getJSModel('premiumplugin')->logAddonDeactivation('export');
        }
        // include_once 'includes/activation.php';
        // JSTExporteactivation::jssupportticketaddon_deactivate();
    }
}

$JSSTExport = new JSSTExport();
