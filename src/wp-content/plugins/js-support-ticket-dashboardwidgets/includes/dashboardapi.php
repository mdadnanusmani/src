 ...
 */
function jssupportticket_addon_add_dashboard_widgets() {

	wp_add_dashboard_widget(
                 'jssupportticket_addon_dashboard_widget',         // Widget slug.
                 jssupportticket::$_config['title'],         // Title.
                 'jssupportticket_addon_dashboard_widget_function' // Display function.
        );
}
add_action( 'wp_dashboard_setup', 'jssupportticket_addon_add_dashboard_widgets' );

/**
 * Create the function to output the contents of our Dashboard Widget.
 */
function jssupportticket_addon_dashboard_widget_function() {
...
function jssupportticket_addon_totalstats_add_dashboard_widgets() {

	wp_add_dashboard_widget(
                'jssupportticket_addon_totalstats_dashboard_widget',         // Widget slug.
                __('Last Month Ticket Stats','js-support-ticket'),         // Title.
                'jssupportticket_addon_totalstats_dashboard_widget_function' // Display function.
    );
}
add_action( 'wp_dashboard_setup', 'jssupportticket_addon_totalstats_add_dashboard_widgets' );

/**
 * Create the function to output the contents of our Dashboard Widget.
 */
function jssupportticket_addon_totalstats_dashboard_widget_function() {
