...
class JSSTroleaccessdepartmentsController {
    ...
    function handleRequest() {
        ...
        if (self::canaddfile()) {
            ...
            $module = JSSTrequest::getVar($module, null, 'roleaccessdepartment');
...
$roleaccessdepartmentsController = new JSSTroleaccessdepartmentsController();
?>
