...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=agent');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Add Staff Member', 'js-support-ticket'); ?></span> </span>
        <form method="post" action="<?php echo admin_url("admin.php?page=agent&task=savestaff"); ?>" enctype="multipart/form-data">
            ...
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Roles', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
            ...
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('First Name', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
            ...
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Last Name', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
            ...
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Email Address', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
