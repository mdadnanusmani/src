<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=agent');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext">    <?php
    if (isset(jssupportticket::$_data[0])) {
        echo jssupportticket::$_data[0]['agent']->firstname . " " .
        jssupportticket::$_data[0]['agent']->lastname . " " . __('Permissions', 'js-support-ticket');
        ?></span> </span>
    <?php
    $colperrow = 3;
    ...
    <div id="tk_form_wraper">
        <form method="post" action="<?php echo admin_url("admin.php?page=agent&task=savepermissions"); ?>">
            <?php
