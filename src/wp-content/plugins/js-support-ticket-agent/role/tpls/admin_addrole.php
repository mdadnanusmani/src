...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=role&jstlay=roles');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Add Role', 'js-support-ticket'); ?></span></span>
        ...
        <div id="tk_form_wraper">
            <form method="post" action="<?php echo admin_url("admin.php?page=role&task=saverole"); ?>">
                <div class="js-form-wrapper" >
                    <span  ><?php echo __('Name', 'js-support-ticket'); ?> : &nbsp;<span style="color: red;" >*</span></span>
