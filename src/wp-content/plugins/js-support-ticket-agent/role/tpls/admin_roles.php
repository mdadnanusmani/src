...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Roles', 'js-support-ticket') ?></span>
    <a class="js-add-link button" href="?page=role&jstlay=addrole"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Role', 'js-support-ticket') ?></a>
        </span>
                    ...
                    foreach (jssupportticket::$_data[0] AS $role) {
                        ...
                        echo " : "; ?></span><a href="?page=role&jstlay=rolepermission&jssupportticketid=<?php echo $role->id; ?>"><?php echo $role->name . ' ' . __('Permissions', 'js-support-ticket'); ?></a></div>
                            <div class="js-col-md-4 js-col-xs-12 seventh js-textaligncenter js-filter-form-action-hl-xs">
                                <a href="?page=role&jstlay=addrole&jssupportticketid=<?php echo $role->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/edit.png" /></a>&nbsp;&nbsp;
                                <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=role&task=deleterole&action=jstask&roleid='. $role->id,'delete-role');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /></a>
                            </div>
                        </div>
