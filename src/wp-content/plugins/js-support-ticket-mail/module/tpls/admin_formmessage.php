...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=mail&jstlay=inbox');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Compose', 'js-support-ticket'); ?></span>
        </span>
        ...
        echo $inbox;
        echo ' )'; ?></a></span>
            <span>	<a class="js-add-link button" href="?page=mail&jstlay=outbox"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/outboxadmin.png"><?php echo __('Outbox', 'js-support-ticket').' (';
        echo jssupportticket::$_data[0]['outboxmessages'];
        echo __(' )  ', 'js-support-ticket'); ?></a></span>
            <span>	<a class="js-add-link button active" href="?page=mail&jstlay=formmessage"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Compose', 'js-support-ticket') ?></a></span>
        </div>
        <form method="post" action="<?php echo admin_url("admin.php?page=mail&task=savemessage"); ?>">
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('To', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
                <div class="js-form-field"><?php echo JSSTformfield::select('toid', JSSTincluder::getJSModel('agent')->getStaffForMailCombobox(), isset(jssupportticket::$_data[0]->toid) ? jssupportticket::$_data[0]->toid : '', __('Select Staff', 'js-support-ticket'), array('class' => 'inputbox', 'data-validation' => 'required')); ?></div>
            </div>
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Subject', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
