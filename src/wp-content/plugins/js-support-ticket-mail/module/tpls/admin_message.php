...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=mail&jstlay=inbox');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Subject', 'js-support-ticket'); ?> &nbsp;&nbsp;<?php echo jssupportticket::$_data[0]['message']->subject ?></span>
        ...
        <form method="post" action="<?php echo admin_url("admin.php?page=mail&task=savereply"); ?>">
            ...
            if (!empty(jssupportticket::$_data[0]['replies']))
                foreach (jssupportticket::$_data[0]['replies'] AS $reply):
                    ?>
                    <div class="js-col-md-2 js-ticket-thread-pic"><img alt="image" src="<?php echo jssupportticket::$_pluginpath . '/includes/images/ticketmanbig.png'; ?>" /></div>
        ...
        echo __(' )  ', 'js-support-ticket'); ?></a></span>
            <span> <a class="js-add-link button" href="admin.php?page=mail&jstlay=formmessage"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Compose', 'js-support-ticket') ?></a></span>

            <div id="postreply">
                <div class="js-form-wrapper">
                    <div class="js-form-title"><label id="responcemsg" for="responce"><?php echo __('Reply', 'js-support-ticket'); ?><span style="color: red;" >*</span></label></div>
        ...
        <?php echo JSSTformfield::hidden('fromid', get_current_user_id()); ?>
