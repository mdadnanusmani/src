...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Inbox', 'js-support-ticket') ?></span>
        </span>
        <form  class="js-filter-form" name="jssupportticketform" id="jssupportticketform" method="post" action="<?php echo admin_url("admin.php?page=mail&jstlay=inbox"); ?>">
            <!-- <span class="subject-txt"><?php echo __('Subject', 'js-support-ticket'); ?>&nbsp;&nbsp;</span> -->
        ...
        <?php if(in_array('agent', jssupportticket::$_active_addons)){ ?>
            <div class="js-admin-content-button">
                <span>  <a class="js-add-link button active" href="<?php if(!JSSTincluder::getJSModel('agent')->isUserStaff()) echo '#'; else echo '?page=mail&jstlay=inbox'; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/inboxadmin.png">  <?php echo __('Inbox', 'js-support-ticket').' (';
            echo $inbox;
            echo ' )'; ?></a></span>
                <span>	<a class="js-add-link button" href="<?php if(!JSSTincluder::getJSModel('agent')->isUserStaff()) echo '#'; else echo '?page=mail&jstlay=outbox'; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/outboxadmin.png"><?php echo __('Outbox', 'js-support-ticket').' (';
            ...
            echo __(' )  ', 'js-support-ticket'); ?></a></span>
                <span>	<a class="js-add-link button" href="<?php if(!JSSTincluder::getJSModel('agent')->isUserStaff()) echo '#'; else echo '?page=mail&jstlay=formmessage'; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Compose', 'js-support-ticket') ?></a></span>
            </div>
            <?php if(!JSSTincluder::getJSModel('agent')->isUserStaff()){ ?>
                <font color="orangered">[<?php echo __('To Use This Feature You Must Be Staff Member','js-support-ticket'); ?>]</font>
            <?php }
        }else{ ?>
            <font color="orangered">[<?php echo __('To Use This Feature You Must Have Agents Addon.','js-support-ticket'); ?>]</font>
            <?php
        }
        if ( in_array('agent', jssupportticket::$_active_addons) && !empty(jssupportticket::$_data[0]['inbox'])) {
            ?>
                ...
                foreach (jssupportticket::$_data[0]['inbox'] AS $inbox) {
                    ...
                    echo " : "; ?></span><?php echo date_i18n(jssupportticket::$_config['date_format'], strtotime($inbox->created)); ?></div>
                        <div class="js-col-md-3 js-col-xs-12 seventh js-filter-form-action-hl-xs">
                            <a href="admin.php?page=mail&jstlay=message&jssupportticketid=<?php echo $inbox->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/edit.png" /></a>&nbsp;&nbsp;
                            <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=mail&task=deletemail&action=jstask&mailid='.$inbox->id,'delete-mail');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /></a>
                            <a href="admin.php?page=mail&task=markasread&mailid=<?php echo $inbox->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/mark_read.png" /></a>&nbsp;&nbsp;
                            <a href="admin.php?page=mail&task=markasunread&mailid=<?php echo $inbox->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/mark_unread.png" /></a>
                        </div>
                    </div>
