...
if (jssupportticket::$_config['offline'] == 2) {
    if (jssupportticket::$_data['permission_granted'] == 1) {
        if (get_current_user_id() != 0) {
                    ...
                    <div class="js-ticket-mail-wrapper">
                        <div class="js-ticket-top-search-wrp">
                            <div class="js-ticket-search-heading-wrp">
                                ...
                                <div class="js-ticket-heading-right">
                                    <a class="js-ticket-add-download-btn" href="<?php echo jssupportticket::makeUrl(array('jstmod'=>'mail', 'jstlay'=>'formmessage')); ?>"><span class="js-ticket-add-img-wrp"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add.png" alt="Add-image"></span><?php echo __('Compose', 'js-support-ticket') ?></a>
                                </div>
                            </div>
                            <div class="js-ticket-search-fields-wrp">
                               <form class="js-filter-form" name="jssupportticketform" id="jssupportticketform" method="POST" action="<?php echo jssupportticket::makeUrl(array('jstmod'=>'mail', 'jstlay'=>'outbox')); ?>">
                        ...
                        <div class="js-ticket-mails-btn-wrp">
                            <div class="js-ticket-mail-btn">
                                <a class="js-add-link button " onmouseover="changeIconTabsOnMouseover(this)" onmouseout="changeIconTabsOnMouseOut(this)"  href="<?php echo esc_url(jssupportticket::makeUrl(array('jstmod'=>'mail', 'jstlay'=>'inbox'))); ?>">
                            ...
                            <div class="js-ticket-mail-btn">
                                <a class="js-add-link button active " onmouseover="changeIconTabsOnMouseover(this)" onmouseout="changeIconTabsOnMouseOut(this)"  href="<?php echo esc_url(jssupportticket::makeUrl(array('jstmod'=>'mail', 'jstlay'=>'outbox'))); ?>">
                        ...
                        <?php if (!empty(jssupportticket::$_data[0]['outbox'])) { ?>
                                        ...
                                        <?php
                                            ...
                                            <div class="js-ticket-data-row">
                                                <div class="js-ticket-table-body-col js-col-md-4 js-col-xs-4">
                                                    ...
                                                    <span class="js-ticket-title"><a class="js-ticket-title-anchor" href="<?php echo esc_url(jssupportticket::makeUrl(array('jstmod'=>'mail', 'jstlay'=>'message', 'jssupportticketid'=>$inbox->id))); ?>"><?php echo __($inbox->subject,"js-support-ticket"); ?></a></span>
                                                </div>
                                                ...
                                                <div class="js-ticket-table-body-col js-col-md-3 js-col-xs-3">
                                                   ...
                                                   <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url(jssupportticket::makeUrl(array('jstmod'=>'mail', 'action'=>'jstask', 'task'=>'deletemail', 'jsstpageid'=>get_the_ID(), 'mailid'=>$inbox->id)),'delete-mail'); ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/downloadicon/delete.png" /></a>
                                                </div>
                                            </div>
                                        <?php } ?>
                                    </div>
            ...
            $redirect_url = jssupportticket::makeUrl(array('jstmod'=>'mail','jstlay'=>'outbox'));
