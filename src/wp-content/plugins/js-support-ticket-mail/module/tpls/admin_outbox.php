...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=mail&jstlay=inbox');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Outbox', 'js-support-ticket') ?></span>
        </span>
        <form  class="js-filter-form" name="jssupportticketform" id="jssupportticketform" method="post" action="<?php echo admin_url("admin.php?page=mail&jstlay=outbox"); ?>">
        ...
        <span><a class="js-add-link button" href="?page=mail&jstlay=inbox"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/inboxadmin.png"><?php echo __('Inbox', 'js-support-ticket').' (';
        echo $inbox;
        echo ' )'; ?></a></span>
        <span><a class="js-add-link button active" href="?page=mail&jstlay=outbox"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/outboxadmin.png"><?php echo __('Outbox', 'js-support-ticket').' (';
            echo jssupportticket::$_data[0]['outboxmessages'];
            echo __(' )  ', 'js-support-ticket'); ?></a></span></span>
        <span><a class="js-add-link button" href="?page=mail&jstlay=formmessage"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Compose', 'js-support-ticket') ?></a>
            ...
            foreach (jssupportticket::$_data[0]['outbox'] AS $inbox) {
                ...
                echo " : "; ?></span><?php echo date_i18n(jssupportticket::$_config['date_format'], strtotime($inbox->created)); ?></div>
                            <div class="js-col-md-3 js-col-xs-12 seventh js-filter-form-action-hl-xs">
                                <a href="?page=mail&jstlay=message&jssupportticketid=<?php echo $inbox->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/edit.png" /></a>&nbsp;&nbsp;
