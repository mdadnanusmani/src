...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Canned Responses', 'js-support-ticket') ?></span>
        <a class="js-add-link button" href="?page=cannedresponses&jstlay=addpremademessage"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Canned Response', 'js-support-ticket') ?></a>
        </span>
        <form class="js-filter-form" name="jssupportticketform" id="jssupportticketform" method="post" action="<?php echo admin_url("admin.php?page=cannedresponses&jstlay=premademessages"); ?>">
        ...
        if (!empty(jssupportticket::$_data[0])) {
            ...
            <div class="js-filter-form-list">
                ...
                foreach (jssupportticket::$_data[0] AS $premade) {
                    ...
                    echo " : "; ?></span><a href="?page=cannedresponses&jstlay=addpremademessage&jssupportticketid=<?php echo $premade->id; ?>"><?php echo $premade->title; ?></a></div>
                    ...
                    echo " : "; ?></span> <a href="<?php echo wp_nonce_url('?page=cannedresponses&task=changestatus&action=jstask&premadeid='.$premade->id,'change-status');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath . 'includes/images/' . $status; ?>"/></a></div>
                    ...
                    echo " : "; ?></span><?php echo $updated ?></div>
                        <div class="js-col-md-2 js-col-xs-12 seventh js-filter-form-action-hl-xs">
                            <a href="?page=cannedresponses&jstlay=addpremademessage&jssupportticketid=<?php echo $premade->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/edit.png" /></a>&nbsp;&nbsp;
                            <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=cannedresponses&task=deletepremademessage&action=jstask&premademessageid='.$premade->id,'delete-premademessage');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /></a>
                        </div>
                    </div>
                <?php
            }
