...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=cannedresponses');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Add Canned Response', 'js-support-ticket'); ?></span></span>
        <form method="post" action="<?php echo admin_url("admin.php?page=cannedresponses&task=savepremademessage"); ?>">
            ...
            <div class="js-form-button">
                <?php echo JSSTformfield::submitbutton('save', __('Save canned response', 'js-support-ticket'), array('class' => 'button')); ?>
            </div>
        </form>
    </div>
</div>
