...
if (jssupportticket::$_config['offline'] == 2) {
    if (jssupportticket::$_data['permission_granted'] == 1) {
        if (get_current_user_id() != 0) {
                        ...
                        <div class="js-ticket-top-search-wrp">
                            <div class="js-ticket-search-heading-wrp">
                                ...
                                <div class="js-ticket-heading-right">
                                    <a class="js-ticket-add-download-btn" href="<?php echo esc_url(jssupportticket::makeUrl(array('jstmod'=>'knowledgebase', 'jstlay'=>'addarticle'))); ?>"><span class="js-ticket-add-img-wrp"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add.png" alt="Add-image"></span><?php echo __('Add Knowledge Base', 'js-support-ticket') ?></a>
                                </div>
                            </div>
                            <div class="js-ticket-search-fields-wrp">
                                <form class="js-filter-form" name="jssupportticketform" id="jssupportticketform" method="POST" action="<?php echo jssupportticket::makeUrl(array('jstmod'=>'knowledgebase', 'jstlay'=>'stafflistarticles')); ?>">
                                    <div class="js-ticket-fields-wrp">
                                        ...
                                        <div class="js-ticket-form-field js-ticket-form-field-select">
                                            <?php echo JSSTformfield::select('jsst-cat', JSSTincluder::getJSModel('knowledgebase')->getCategoryForCombobox('kb'), jssupportticket::$_data['filter']['jsst-cat'], __('Select Category', 'js-support-ticket'), array('class' => 'js-ticket-select-field')); ?>
                                        </div>
                                    </div>
                                ...
                                <div class="js-ticket-download-content-wrp">
                                    <div class="js-ticket-table-wrp js-col-md-12">
                                        ...
                                        <div class="js-ticket-table-body">
                                            <?php foreach (jssupportticket::$_data[0] AS $article) {
                                                $type = '';
                                                if ($article->type == 1)
                                                ...
                                                <div class="js-ticket-data-row">
                                                    <div class="js-ticket-table-body-col js-col-md-4 js-col-xs-4">
                                                        ...
                                                        <span class="js-ticket-title"><a class="js-ticket-title-anchor" href="<?php echo esc_url(jssupportticket::makeUrl(array('jstmod'=>'knowledgebase', 'jstlay'=>'articledetails', 'jssupportticketid'=>$article->id))); ?>"><?php echo __($article->subject); ?></a></span>
                                                    </div>
                                                    ...
                                                    <div class="js-ticket-table-body-col js-col-md-2 js-col-xs-2">
                                                        ...
                                                        <?php echo date_i18n(jssupportticket::$_config['date_format'], strtotime($article->created)); ?>
                                                    </div>
                                                    <div class="js-ticket-table-body-col js-col-md-2 js-col-xs-2">
                                                        <span class="js-ticket-display-block"><?php echo __('Action','js-support-ticket'); ?>:</span>
                                                        <a href="<?php echo jssupportticket::makeUrl(array('jstmod'=>'knowledgebase', 'jstlay'=>'addarticle', 'jssupportticketid'=>$article->id)); ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/downloadicon/edit.png" /></a>&nbsp;&nbsp;
                                                            <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url(jssupportticket::makeUrl(array('jstmod'=>'knowledgebase', 'task'=>'deletearticle', 'action'=>'jstask', 'articleid'=>$article->id, 'jsstpageid'=>get_the_ID())),'delete-article'); ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/downloadicon/delete.png" /></a>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                        </div>
            ...
            $redirect_url = jssupportticket::makeUrl(array('jstmod'=>'knowledgebase', 'jstlay'=>'stafflistarticles'));
