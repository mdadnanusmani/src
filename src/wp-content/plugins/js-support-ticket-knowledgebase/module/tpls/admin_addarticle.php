...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=knowledgebase&jstlay=listarticles');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Add Knowledge Base', 'js-support-ticket'); ?></span>
        </span>
        <form method="post" action="<?php echo admin_url("admin.php?page=knowledgebase&task=savearticle"); ?>" enctype="multipart/form-data" >
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Category', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
