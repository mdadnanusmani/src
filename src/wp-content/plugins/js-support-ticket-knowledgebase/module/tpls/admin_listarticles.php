...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Knowledge Base', 'js-support-ticket') ?></span>
    <a class="js-add-link button" href="?page=knowledgebase&jstlay=addarticle"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Knowledge Base', 'js-support-ticket') ?></a>
        </span>
        ...
        if (!empty(jssupportticket::$_data[0])) {
            ...
            <div class="js-filter-form-list">
                <div class="js-filter-form-head js-filter-form-head-xs">
                    ...
                    <div class="js-col-md-3 js-col-xs-12 first"><?php echo __('Category', 'js-support-ticket'); ?></div>
                    <?php /*<div class="js-col-md-1 js-col-xs-12 second js-textaligncenter"><?php echo __('Type', 'js-support-ticket'); ?></div>*/ ?>
                ...
                foreach (jssupportticket::$_data[0] AS $article) {
                    ...
                    echo " : "; ?></span><?php echo $article->categoryname; ?></div>
                        <?php /*<div class="js-col-md-1 js-col-xs-12 second js-textaligncenter"><span class="js-filter-form-data-xs"><?php echo __('Type', 'js-support-ticket');
                    ...
                    echo " : "; ?></span>
                            <?php if ($number != 0 || $pagenum > 1) {
                                $url  = "?page=knowledgebase&task=ordering&action=jstask&order=up&articleid=".$article->id;
                                if($pagenum > 1){
                                    $url .= '&pagenum=' . $pagenum;
                                } ?>
                            ...
                            if ($number < $count) {
                                $url  = "?page=knowledgebase&task=ordering&action=jstask&order=down&articleid=".$article->id;
                                if($pagenum > 1){
                                    $url .= '&pagenum=' . $pagenum;
                                } ?>
                ...
                echo " : "; ?></span><a href="<?php echo wp_nonce_url('?page=knowledgebase&task=changestatusarticle&action=jstask&articleid='.$article->id,'change-status-article');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath . 'includes/images/' . $status; ?>" /> </a></div>
                ...
                echo " : "; ?></span><?php echo date_i18n(jssupportticket::$_config['date_format'], strtotime($article->created)); ?></div>
                        <div class="js-col-md-2 js-col-xs-12 seventh js-filter-form-action-hl-xs js-textaligncenter">
                            <a href="?page=knowledgebase&jstlay=addarticle&jssupportticketid=<?php echo $article->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/edit.png" /></a>&nbsp;&nbsp;
                            <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=knowledgebase&task=deletearticle&action=jstask&articleid='.$article->id,'delete-article'); ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /></a>
                        </div>
                    </div>
