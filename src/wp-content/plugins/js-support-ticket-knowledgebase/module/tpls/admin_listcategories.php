...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=jssupportticket&jstlay=controlpanel');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Categories', 'js-support-ticket') ?></span>
    <a class="js-add-link button" href="?page=knowledgebase&jstlay=addcategory"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Category', 'js-support-ticket') ?></a>
    </span>
    ...
    if (!empty(jssupportticket::$_data[8])) {
        ...
        <div class="js-filter-form-list">
            <div class="js-filter-form-head js-filter-form-head-xs">
                <div class="js-col-md-7 js-col-xs-12 first"><?php echo __('Category Title', 'js-support-ticket'); ?></div>
            ...
            foreach (jssupportticket::$_data[8] AS $category) {
                ...
                <div class="js-filter-form-data">
                    <div class="js-col-md-7 js-col-xs-12 first"><span class="js-filter-form-data-xs"><?php echo __('Category Title', 'js-support-ticket');
            ...
            echo " : "; ?></span> <a href="<?php echo wp_nonce_url('?page=knowledgebase&task=changestatuscategory&action=jstask&categoryid='.$category->id, 'change-status-category');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath . 'includes/images/' . $status; ?>" /> </a></div>
            ...
            echo " : "; ?></span><?php echo date_i18n(jssupportticket::$_config['date_format'], strtotime($category->created)); ?></div>
                    <div class="js-col-md-2 js-col-xs-12 seventh js-filter-form-action-hl-xs">
                        <a href="?page=knowledgebase&jstlay=addcategory&jssupportticketid=<?php echo $category->id; ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/edit.png" /></a>&nbsp;&nbsp;
                        <a onclick="return confirm('<?php echo __('Are you sure to delete', 'js-support-ticket'); ?>');" href="<?php echo wp_nonce_url('?page=knowledgebase&task=deletecategory&action=jstask&categoryid='.$category->id,'delete-category'); ?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" /></a>
                    </div>
                </div>
