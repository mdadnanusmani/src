    ...
    function checkCategoriesParent(val, type) {
        ...
        if (val == true && parentid != '') {
            ...
            jQuery.post(ajaxurl, {action: 'jsticket_ajax', currentid: currentid, type: type, jstmod: 'knowledgebase', task: 'checkChildType'}, function (data) {
                if (data) {
                    jQuery("div#msgshowcategory").html(data);
                    jQuery("input#" + type + "1").attr('checked', val);
                }
            });
        }
    }
...
<div id="jsstadmin-wrapper">
    ...
    <span class="js-adminhead-title"><a class="jsanchor-backlink" href="<?php echo admin_url('admin.php?page=knowledgebase&jstlay=listcategories');?>"><img alt="image" src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/back-icon.png" /></a><span class="jsheadtext"><?php echo __('Add Category', 'js-support-ticket'); ?></span>
        </span>
        <form method="post" enctype="multipart/form-data" action="<?php echo admin_url("admin.php?page=knowledgebase&task=savecategory"); ?>">
            <div class="js-form-wrapper">
                <div class="js-form-title"><?php echo __('Category Name', 'js-support-ticket'); ?>&nbsp;<span style="color: red;" >*</span></div>
            ...
            <div class="js-form-wrapper">
                ...
                <div class="js-form-field">
                    <input type="file" class="inputbox" name="filename"  size="20" maxlenght='30' onchange="uploadfile(this, '<?php echo jssupportticket::$_config['file_extension']; ?>');" />
                    <?php
                    if (isset(jssupportticket::$_data[0]))
                        if (jssupportticket::$_data[0]->logo != '') {
                            ...
                            ?> <img width="50px" height="50px" src="<?php echo esc_url($path); ?>"> <?php
                        }
                    ?>
                </div>
            </div>
